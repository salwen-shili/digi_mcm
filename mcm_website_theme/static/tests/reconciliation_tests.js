  ...
  var db = {
    ...
    'account.tax': {
      ...
      json_friendly_compute_all: function (args) {
        ...
        var amount = args[1];
        var tax_base = tax.price_include
    ...
    'account.reconciliation.widget': {
      ...
      process_bank_statement_line: function (args) {
        var datas = args[1];
        var ids = _.flatten(
          _.pluck(_.pluck(datas, 'counterpart_aml_dicts'), 'counterpart_aml_id')
        );
  ...
  QUnit.module(
    ...
    function () {
      ...
      QUnit.test('Reconciliation basic data', async function (assert) {
        ...
        assert.strictEqual(
          clientAction.widgets[1].$('.mv_line .cell_left:contains(".")').length,
          2,
                ...
                assert.deepEqual(
                  ...
                  [
                    ...
                    [
                      {
                        partner_id:
                          lines.length == 1 ? lines[0].partner_id : false,
                        counterpart_aml_dicts: [
                          {
                            analytic_tag_ids: [[6, null, []]],
