...
class Sale(models.Model):
    ...
    def create(self, vals):
        ...
        if partner  and not partner.bolt and self.module_id.product_id.default_code != "vtc_bolt":
    ...
    def write(self, vals):
        ...
        if 'state' in vals:
            if vals['state'] == 'sent':
                ...
                if (partner.mcm_session_id.id) and (partner.mcm_session_id.id == self.session_id.id) and partner.bolt and  self.module_id.product_id.default_code != "vtc_bolt" :
                    print('contrat signé')
