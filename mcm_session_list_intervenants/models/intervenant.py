...
class Intervenant(models.Model):
    ...
    date_naissance = fields.Date(string="Date de naissance", related="intervenant_id.birthday")
    ville_naissance = fields.Char(string="Ville de naissance", related="intervenant_id.birth_city")
